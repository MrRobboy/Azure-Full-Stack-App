...
--
-- Hôte : localhost:3306
-- Généré le : sam. 03 mai 2025 à 21:35
...
VALUES
  ...
  (5, '2A4', '2ème Année', 'Alternance', '4'),
  (
    6,
    '2A5 (aka la classe bien guez)',
    '2ème Année',
    'Alternance',
    '5'
  ),
...
--
INSERT INTO
  `EXAM` (`id_exam`, `titre`, `matiere`, `classe`, `date`)
VALUES
...
--
ALTER TABLE `USER_PRIVILEGES` ADD PRIMARY KEY (`id_user`),
...
--
ALTER TABLE `USER_PRIVILEGES` ADD CONSTRAINT `user_privileges_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `USER` (`id_user`) ON DELETE CASCADE;
